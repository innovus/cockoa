...
function getCantidadInasistenciaMateria(req, res) {
    InasistenciaDao.findCantidadInasistenciasBYMateria(30011).then(function(data) {
...
function getInasistenciasCarga(req, res) {
    InasistenciaDao.findInasistenciasByCarga(req.params.id_carga).then(function(data) {
        respuesta.sendJsonResponse(res, 200, data);
        console.log("la fucnion salio bn" + data)
    }).catch(function(err) {
        if (err.message == 'No data returned from the query.') {
...
function getCantidadInasistenciasCarga(req, res) {
    InasistenciaDao.findCantidadInasistenciasByCarga(req.params.id_carga).then(function(data) {
        var data1 = {};
        //(function(i){
...
function getMiInasistencia(req, res) {
    InasistenciaDao.findInasistenciasByEstudiante(1).then(function(data) {
        respuesta.sendJsonResponse(res, 200, data);
        console.log("la fucnion salio bn" + data)
    }).catch(function(err) {
        if (err.message == 'No data returned from the query.') {
...
function getInasistenciaPorCarga(req, res) {
    InasistenciaDao.findInasistenciasByCarga(req.params.id_estudiante, req.params.id_carga).then(function(data) {
        respuesta.sendJsonResponse(res, 200, data);
        console.log("la fucnion salio bn" + data)
    }).catch(function(err) {
        if (err.message == 'No data returned from the query.') {
    ...
    InasistenciaDao.addInasistencias(req.body).then(function() {
        ...
        req.body.forEach(function(inasistencia, index) {
            var notificacion = {
                ...
                'id_estudiante': inasistencia.id_estudiante,
                'guia': inasistencia.id_carga
            };
        ...
        NotificacionDao.insertarNotificaciones(notificaciones).then(function(data) {
            ...
            //manda la respuesta
        respuesta.sendJsonResponse(res, 200, {
            'mensaje': 'Inasistencias insertada'
        });
    }).catch(function(error) {
        respuesta.sendJsonResponse(res, 500, []);
...
function getMateriasWithInasistenciaByEstudiante(req, res) {
    MateriaDao.findMateriasWithInasistenciaByEstudiante(30011).then(function(data) {
        respuesta.sendJsonResponse(res, 200, data);
        console.log("la fucnion salio bn" + data);
    }).catch(function(err) {
        if (err.message == 'No data returned from the query.') {
...
function getInasistenciasByMateria(req, res) {
    InasistenciaDao.findInasistenciasByMateria(30011, req.params.id_materia).then(function(data) {
        respuesta.sendJsonResponse(res, 200, data);
        console.log("la fucnion salio bn" + data);
    }).catch(function(err) {
        if (err.message == 'No data returned from the query.') {
...
function updateEstadoInasistencia(req, res) {
    InasistenciaDao.updateEstadoInasistencia(req.body).then(function(data) {
        respuesta.sendJsonResponse(res, 200, {
            'msg': 'Inasistencia Actualizada'
        });
    }).catch(function(err) {
        respuesta.sendJsonResponse(res, 500, {
