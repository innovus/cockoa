...
var findActividadesByLogro = function(id_logro) {
    return sequelize.query(queries.actividad.findActividadesByLogro, {
        bind: {
            id_logro: id_logro
        },
...
var findActividadById = function(id_actividad) {
    return sequelize.query(queries.actividad.findActividadById, {
        bind: {
...
var createActividad = function(actividad) {
    var cadena = "INSERT INTO actividad" + "(id_logro,porcentaje_actividad,nombre_actividad,descripcion_actividad) " + "VALUES (" + actividad.id_logro + "," + actividad.porcentaje_actividad + ",'" + actividad.nota_actividad + "','" + actividad.descripcion_actividad + "') RETURNING id_actividad";
    console.log(cadena);
    return sequelize.query(cadena, {
...
var guardarActividadesTransaccion = function(deleteA, updateA, createA, cb) {
    ...
    sequelize.transaction({
            ...
            switch (value) {
                case 1: //C - U - D
                    deleteActividades(deleteA, t).then(function(dataDelete) {
                        console.log("entro al segundo then de transaccion")
                        updateActividades(updateA, t).then(function(dataUpdate) {
                            console.log("entro a el tercer then de la transaccion");
                            createActividades(createA, t).then(function(dataCreate) {
...
var updateDescripcionActividad = function(actividad) {
    var cadena = "UPDATE actividad " + "SET descripcion_actividad = '" + actividad.descripcion_actividad + "' " + "WHERE id_actividad = " + actividad.id_actividad;
    console.log(cadena);
    return sequelize.query(cadena, {
        type: sequelize.QueryTypes.UPDATE
    });
...
var deleteActividades = function(actividades, t) {
    var cadena = "DELETE FROM actividad " + "WHERE id_actividad IN (";
    var cadenaValores = "";
    actividades.forEach(function(actividad, index) {
...
var deleteActividad = function(id_actividad, t) {
    var cadena = "DELETE FROM actividad " + "WHERE id_actividad = " + id_actividad;
    return sequelize.query(cadena, {
        type: sequelize.QueryTypes.DELETE
    });
};
