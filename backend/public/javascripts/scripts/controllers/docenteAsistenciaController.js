...
app.controller('docenteAsistenciaController',['$scope','$http','$cookieStore', '$cookies',function($scope,$http,$cookieStore,$cookies){
  ...
  //  $scope.formData = {};
    ...
    $http.get('/inasistencias/inasistencias')
        ...
        $scope.getAsistenciasCarga = function (id_carga){
          $http.get('/inasistencias/inasistencias')
