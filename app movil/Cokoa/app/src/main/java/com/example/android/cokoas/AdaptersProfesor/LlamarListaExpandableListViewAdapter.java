...
/**
 * Created by juancarlospantoja@hotmail.com on 15/02/2017.
 */
public class LlamarListaExpandableListViewAdapter extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<MateriaProfesor> materiaProfesors;

    public LlamarListaExpandableListViewAdapter(Context context, ArrayList<MateriaProfesor> materiaProfesors) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, LlamarListaActivity.class);
                intent.putExtra("id_carga_docente", idCargaDocente);
