 ...
 */
public class PerfilProfesorAsyntask extends AsyncTask<Void,Void,Perfil> {
    SessionManager sessionManager;
    Activity activity;
    String serverUrls = AppConstants.serverUrl;

    ProgressDialog progressDialog;
    private final String LOG_TAG = PerfilProfesorAsyntask.class.getSimpleName();
    public PerfilProfesorAsyntask(Activity activity){
        super();
