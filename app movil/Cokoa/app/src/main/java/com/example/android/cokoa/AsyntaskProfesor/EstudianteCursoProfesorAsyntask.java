 ...
 */
public class EstudianteCursoProfesorAsyntask  extends AsyncTask<Void,Void,ArrayList<EstudianteCurso>>{
    ...
    private final String LOG_TAG = EstudianteCursoProfesorAsyntask.class.getSimpleName();

    private Activity activity;


    public EstudianteCursoProfesorAsyntask(Activity activity) {
        super();
