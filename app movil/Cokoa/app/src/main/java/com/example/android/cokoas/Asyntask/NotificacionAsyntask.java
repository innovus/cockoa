    ...
    public ArrayList<Notificacion> getNotificacion(String notificacionJson)throws JSONException {
        if(notificacionJson!=null){
            ...
            for (int i = 0;i<jsonArray.length();i++){
                ...
                String estadoNotificacion = jsonObject.getString("estado_notificacion");


                String guia = jsonObject.getString("guia");
                ...
                notificacion.setEstadoNotificaion(estadoNotificacion);

                notificacion.setGuia(guia);
