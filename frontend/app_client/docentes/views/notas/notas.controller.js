...
(function() {
    ...
    }).controller('docentes_notasController', docentes_notasController).controller('showLogroController', showLogroController).controller('showActividadController', showActividadController).controller('waitCtrl', waitCtrl);
    /*
