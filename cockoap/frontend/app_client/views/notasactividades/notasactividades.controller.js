...
/**
 * @file archivo que contiene el controlador de notasActividadesController
 * @name notasactividades.controller.js
...
(function() {
    ...
    }).controller('docentes_notasActividadesController', docentes_notasActividadesController).controller('showLogroActividadesController', showLogroActividadesController).controller('showActividadActividadesController', showActividadActividadesController).controller('waitCtrl', waitCtrl);
    /*
    ...
    */
    ...
    showLogroActividadesController.$inject = ['$scope', '$uibModalInstance', 'logro'];

    function showLogroActividadesController($scope, $uibModalInstance, logro) {
        $scope.logro = logro
        $scope.ok = function() {
    ...
    showActividadActividadesController.$inject = ['$scope', '$uibModalInstance', 'actividad'];

    function showActividadActividadesController($scope, $uibModalInstance, actividad) {
    ...
    docentes_notasActividadesController.$inject = ['$scope', '$http', '$cookieStore', '$cookies', 'CONFIG', 'periodoData', 'estudianteData', 'actividadData', 'logroData', 'nota_actividadData', 'nota_logroData', '$filter', '$uibModal', 'myutils'];

    function docentes_notasActividadesController($scope, $http, $cookieStore, $cookies, CONFIG, periodoData, estudianteData, actividadData, logroData, nota_actividadData, nota_logroData, $filter, $uibModal, myutils) {
            ...
            getNotasActividades(carga.id_carga_docente, function(notas_actividades) {
                    ...
                    getEstudiantes(carga.id_curso, function(estudiantes) {
                            ...
                            getLogros(carga.id_carga_docente, function(logros) {
                                    ...
                                    console.log(logros)
                                        //me trae todas las actividades de esos logros
                                    getActividadesByLogros(logros, function(actividades) {
                                        //recorro los logros 
                                        $scope.logros.forEach(function(logro, index) {
                                            //creo un filtro para obtener las actividades por cada logro y agregarle
                                            //al vector de logro
