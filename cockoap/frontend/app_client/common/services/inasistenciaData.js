(function() {
    /**
     * @ngdoc service
     * @name docentes.service: inasistenciaData
     * @requires $http
     * @requires CONFIG
     ...
     * @description 
     * 
     * servicio que permite hacer consultas de la tabla inasistencia de la base de datos
     */
    ...
    function inasistenciaData($http, CONFIG, autenticacion) {
        ...
        var findInasistenciasEstudianteByCarga = function(id_carga) {
            return $http.get(CONFIG.http_address + '/inasistencias/estudiante/carga/' + id_carga, {
                headers: {
                    Authorization: 'Bearer ' + autenticacion.getToken()
                }
            })
